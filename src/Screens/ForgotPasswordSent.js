...
const ForgotPasswordSent = ({ navigation }) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, padding: 15, backgroundColor: "#F5F7FF" }}>
            ...
            <View style={{ flex: 1, alignItems: "center", justifyContent: "space-between", paddingTop: "5%" }}>
                <View>
                    <Text style={{ fontWeight: "700", fontSize: 24, textAlign: "center" }}>Your email is on the way</Text>
                    <Text style={{ fontFamily: "inter", fontSize: 14, textAlign: "center", padding: 40 }}>Check your email test@test.com and follow the instructions to reset your password</Text>
                </View>
                <View>
