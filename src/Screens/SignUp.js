    ...
    return (
        <SafeAreaView style={{ flex: 1, padding: 15, backgroundColor: "#F5F7FF" }}>
            ...
            <View style={{ flex: 9, backgroundColor: "#F5F7FF" }}>
                <Text style={{ fontFamily: "Inter", fontSize: 24, fontWeight: "700", color: "#240F51" }}>Welcome to Brees</Text>
                <Spacer height={20} />
                <Text style={{ fontFamily: "Inter", fontSize: 14, color: "#292B2D" }}>Complete the sign up to get started</Text>
                <Spacer height={20} />
                <View style={{}}>
                    <FloatingLabelInput
                        label={'Name'}
                        value={nameCont}
                        onChangeText={value => setnameCont(value)}
